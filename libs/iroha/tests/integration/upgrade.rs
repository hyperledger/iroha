...
use iroha_executor_custom_data_model::permissions::CanControlDomainLives;
...
fn executor_upgrade_should_work() -> Result<()> {
    ...
    upgrade_executor(&client, "../../samples/executors/admin")?;
...
fn executor_upgrade_should_run_migration() -> Result<()> {
    ...
    upgrade_executor(&client, "../../samples/executors/custom_permission")?;
...
fn executor_upgrade_should_revoke_removed_permissions() -> Result<()> {
    ...
    upgrade_executor(&client, "../../samples/executors/remove_permission")?;
...
fn executor_custom_instructions_complex() -> Result<()> {
    use iroha_executor_custom_data_model::complex_isi::{
...
fn migration_fail_should_not_cause_any_effects() {
    ...
    let _err = upgrade_executor(&client, "../../samples/executors/migration_fail")
...
fn migration_should_cause_upgrade_event() {
    ...
    upgrade_executor(&client, "../../samples/executors/custom_permission").unwrap();
...
fn define_custom_parameter() -> Result<()> {
    use iroha_executor_custom_data_model::parameters::DomainLimits;
    ...
    upgrade_executor(&client, "../../samples/executors/custom_parameter").unwrap();
