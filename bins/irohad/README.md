...
We highly recommend you to generate a new key pair for any non-testing deployment. We also recommend using the `Ed25519` algorithm. For convenience, you can use the provided [`kagami`](../kagami/README.md) tool to generate key pairs. For example,
...
Refer to [generating key pairs with `kagami`](../kagami#crypto) for more details.
