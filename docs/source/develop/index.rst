...
It might help you understand the general idea of how frontend can be used with HL Iroha. You can also check out `sample web javascript wallet <https://github.com/soramitsu/iroha-wallet-js>`_ developed in `Vue <https://vuejs.org/>`_.
