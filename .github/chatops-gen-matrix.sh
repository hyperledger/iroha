...
readonly DEFAULT_macos_compilers="clang"  AVAILABLE_macos_compilers="clang" #FIXME vcpkg on CI fails to build llvm gcc-10"
readonly DEFAULT_windows_compilers="msvc" AVAILABLE_windows_compilers="msvc" #No need in other compilers clang mingw cygwin"
