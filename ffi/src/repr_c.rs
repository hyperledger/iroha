...
/// Marker trait indicating that the type, when converted into corresponding [`CType`],
/// doesn't reference conversion context. This is useful to determine which types can be
/// returned from and FFI function and affects how they are returned.
///
/// # Example
///
/// 1. `&mut [u8]`
...
/// will be `*mut SliceMut<u8>`, i.e. a pointer to a location where to store the slice's
...
/// # Safety
///
/// Type must not use store during conversion into [`CType`], i.e. reference local context
