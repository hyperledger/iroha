...
use crate::{
    ...
    parameters::{
        defaults::{
            chain_wide::*, kura::*, logger::*, network::*, queue::*, snapshot::*, torii::*,
        },
        user_layer,
        user_layer::{
            ChainWide, ExtendsPaths, Genesis, Iroha, Kura, KuraDebug, Logger, Network, Queue, Root,
            Snapshot, Sumeragi, SumeragiDebug, Telemetry, TelemetryDev, Torii, UserTrustedPeers,
        },
    },
};
        ...
        Self: Sized,
    {
        ...
        let public_key =
            ParseEnvResult::parse_simple(&mut emitter, env, "PUBLIC_KEY", "iroha.public_key")
                .into();
        let private_key =
            user_layer::private_key_from_env(&mut emitter, env, "PRIVATE_KEY", "iroha.private_key")
                .into();
        let p2p_address =
...
impl FromEnv for GenesisPartial {
        ...
        Self: Sized,
    {
        ...
        .into();
        let private_key = user_layer::private_key_from_env(
            &mut emitter,
            env,
            "GENESIS_PRIVATE_KEY",
            "genesis.private_key",
