...
use super::utils::{
    ...
    StructWithFields, View, ViewFieldType, ViewIgnore,
};
...
pub fn gen_original_struct(mut ast: StructWithFields) -> StructWithFields {
    remove_attr_struct(&mut ast, "view");
    ast
}

#[allow(clippy::str_to_string, clippy::expect_used)]
pub fn gen_view_struct(mut ast: StructWithFields) -> StructWithFields {
...
pub fn gen_impl_has_view(original: &StructWithFields) -> proc_macro2::TokenStream {
    let StructWithFields {
        generics,
        ident: view_ident,
        ..
...
pub fn gen_assertions(view: &StructWithFields) -> proc_macro2::TokenStream {
