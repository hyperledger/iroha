...
use iroha_config_base::{
    ...
    proxy::Documented as _,
};
use serde::{Deserialize, Serialize};

#[derive(Clone, Debug, Deserialize, Serialize, Documented, Combine)]
...
#[derive(Clone, Debug, Deserialize, Serialize, Documented, Combine, PartialEq, Eq)]
