...
* [`kagami`](iroha_kagami) is used to generate cryptographic keys, default genesis, configuration reference, and schema.
...
* [`iroha_macro`](iroha_macro) provides the convenience macros.
