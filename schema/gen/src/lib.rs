...
types!(
    ...
    IterableQueryWithFilter<FindAccounts, AccountPredicateBox>,
    IterableQueryWithFilter<FindActiveTriggerIds, TriggerIdPredicateBox>,
    IterableQueryWithFilter<FindAssets, AssetPredicateBox>,
    IterableQueryWithFilter<FindAssetsDefinitions, AssetDefinitionPredicateBox>,
    IterableQueryWithFilter<FindBlockHeaders, BlockHeaderPredicateBox>,
    IterableQueryWithFilter<FindBlocks, SignedBlockPredicateBox>,
    IterableQueryWithFilter<FindDomains, DomainPredicateBox>,
    IterableQueryWithFilter<FindPeers, PeerPredicateBox>,
    IterableQueryWithFilter<FindRoleIds, RoleIdPredicateBox>,
    IterableQueryWithFilter<FindRoles, RolePredicateBox>,
    IterableQueryWithFilter<FindTransactions, TransactionQueryOutputPredicateBox>,
