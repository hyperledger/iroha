...
types!(
    ...
    IterableQueryParams,
    IterableQueryWithFilter<FindAccountsWithAsset, AccountPredicateBox>,
    IterableQueryWithFilter<FindAllAccounts, AccountPredicateBox>,
    IterableQueryWithFilter<FindAllActiveTriggerIds, TriggerIdPredicateBox>,
    IterableQueryWithFilter<FindAllAssets, AssetPredicateBox>,
    IterableQueryWithFilter<FindAllAssetsDefinitions, AssetDefinitionPredicateBox>,
    IterableQueryWithFilter<FindAllBlockHeaders, BlockHeaderPredicateBox>,
    IterableQueryWithFilter<FindAllBlocks, SignedBlockPredicateBox>,
    IterableQueryWithFilter<FindAllDomains, DomainPredicateBox>,
    IterableQueryWithFilter<FindAllPeers, PeerPredicateBox>,
    IterableQueryWithFilter<FindAllRoleIds, RoleIdPredicateBox>,
    IterableQueryWithFilter<FindAllRoles, RolePredicateBox>,
    IterableQueryWithFilter<FindAllTransactions, TransactionQueryOutputPredicateBox>,
    IterableQueryWithFilter<FindPermissionsByAccountId, PermissionPredicateBox>,
    IterableQueryWithFilter<FindRolesByAccountId, RoleIdPredicateBox>,
    IterableQueryWithFilter<FindTransactionsByAccountId, TransactionQueryOutputPredicateBox>,
    IterableQueryWithParams,
    JsonString,
    Level,
    Log,
    MathError,
...
pub mod complete_data_model {
    ...
    pub use iroha_data_model::{
        ...
        query::{
            ...
            IterableQueryOutput, IterableQueryOutputBatchBox, IterableQueryWithFilter,
            IterableQueryWithParams, QueryRequestWithAuthority, QueryResponse, QuerySignature,
            SignedQuery, SignedQueryV1, SingularQueryOutputBox,
        },
        transaction::{
