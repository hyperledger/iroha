...
pub fn generate_map() -> DumpDecodedMap {
    let mut map = generate_map! {
        ...
        BTreeSet<permission::PermissionToken>,
        BlockHeaderValue,
        ...
        Vec<isi::Instruction>,
        Vec<permission::PermissionToken>,
        ...
        iroha_data_model::predicate::numerical::SemiRange,
        ...
        iroha_data_model::predicate::numerical::Interval<iroha_primitives::fixed::Fixed>,
        iroha_data_model::predicate::numerical::Interval<u128>,
        iroha_data_model::predicate::numerical::Interval<u32>,
        iroha_data_model::predicate::numerical::Interval<u8>,
        iroha_data_model::predicate::numerical::Interval<u16>,
        iroha_data_model::predicate::ip_addr::Ipv4Predicate,
        [iroha_data_model::predicate::ip_addr::Ipv4Predicate; 4],
        iroha_data_model::predicate::ip_addr::Ipv6Predicate,
        [iroha_data_model::predicate::numerical::Interval<u16>; 8],
        [iroha_data_model::predicate::numerical::Interval<u8>; 4],
        ...
        smartcontracts::isi::error::Mismatch<smartcontracts::isi::permission::ValidatorType>,
        smartcontracts::isi::permission::ValidatorType,
