...
pub fn generate_map() -> DumpDecodedMap {
    ...
    let mut map = generate_map! {
        ...
        BTreeMap<PublicKey, SignatureOf<block::CandidateBlock>>,
        ...
        BTreeSet<PublicKey>,
        BTreeSet<RoleId>,
        BTreeSet<SignatureOf<block::CandidateBlock>>,
        ...
        Option<trigger::Id>,
        Option<TriggerExecutedStatusKind>,
        Option<u32>,
        Or,
        ...
        TriggerExecutedEventFilter,
        TriggerExecutedStatus,
        TriggerExecutedStatusKind,
        TriggerFilter,
        TriggerId,
        ...
        ValueKind,
        Vec<Hash>,
        Vec<HashOf<block::VersionedCandidateBlock>>,
        Vec<PeerId>,
        Vec<PermissionToken>,
        ...
        block::VersionedCandidateBlock,
        block::stream::BlockMessage,
        block::stream::BlockSubscriptionRequest,
        block::stream::VersionedBlockMessage,
        block::stream::VersionedBlockSubscriptionRequest,
        bool,
        core::time::Duration,
        domain::IpfsPath,
        domain::NewDomain,
        ...
        events::FilterBox,
        events::VersionedEventMessage,
        events::VersionedEventSubscriptionRequest,
