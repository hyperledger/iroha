...
async fn find_asset() {
    QuerySet::new()
        ...
        .query(FindAssetById::new(AssetId::test(
...
fn query() -> impl Query {
    FindAccountById::new(AccountId::test("alice", DOMAIN))
}
#[tokio::test]
