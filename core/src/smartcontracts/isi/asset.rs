        ...
        fn execute(
            ...
            wsv.modify_asset(&asset_id, |asset| {
                ...
                *quantity = quantity
                ...
                Ok(DataEvent::new(asset_id.clone(), DataStatus::Created))
            })
        }
    }
    ...
    impl<W: WorldTrait> Execute<W> for SetKeyValue<Asset, Name, Value> {
        ...
        fn execute(
            ...
            wsv.modify_asset(&asset_id, |asset| {
                ...
                Ok(DataEvent::new(asset_id.clone(), MetadataUpdated::Inserted))
            })
        }
    }
        ...
        fn execute(
            ...
            wsv.modify_asset(&asset_id, |asset| {
                ...
                *quantity = quantity
                ...
                Ok(DataEvent::new(asset_id.clone(), DataStatus::Deleted))
            })
        }
    }
    ...
    impl<W: WorldTrait> Execute<W> for RemoveKeyValue<Asset, Name> {
        ...
        fn execute(
            ...
            wsv.modify_asset(&asset_id, |asset| {
                ...
                Ok(DataEvent::new(asset_id.clone(), MetadataUpdated::Removed))
            })
        }
    }
        ...
        fn execute(
            ...
            wsv.modify_asset(&source_asset_id, |asset| {
                ...
                *quantity = quantity
                ...
                Ok(DataEvent::new(source_asset_id.clone(), AssetUpdated::Sent))
            })?;
