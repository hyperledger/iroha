...
pub use self::model::*;
use self::{
    account::*, asset::*, block::*, domain::*, executor::*, peer::*, permission::*, role::*,
    transaction::*, trigger::*,
};
use crate::{
...
pub mod prelude {
    pub use super::{
        ...
        executor::prelude::*, peer::prelude::*, permission::prelude::*, role::prelude::*,
        transaction::prelude::*, trigger::prelude::*, FetchSize, QueryBox, QueryId,
