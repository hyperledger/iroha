...
static const std::string kExpectedPubkey{"expected_pubkey"};
static const std::string kActualPubkey{"actual_pubkey"};
static const std::string kActualPubkey2{"actual_pubkey_2"};
