 ...
 public:
  ...
  void initAndCommitState(const NetworkUtil &network_util) {
    ...
    for (auto i = initial_round.block_round;
      ...
      yac->processRoundSwitch(top_hash_->vote_round, order.getPeers(), shared_model::interface::types::PeerList{});
    ...
    yac->processRoundSwitch(next_hash.vote_round, order.getPeers(), shared_model::interface::types::PeerList{});
