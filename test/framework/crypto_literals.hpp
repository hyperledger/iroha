...
inline shared_model::interface::types::PublicKeyHexStringView operator""_hex_pubkey(
    const char *c, size_t s) {
  return shared_model::interface::types::PublicKeyHexStringView{
      std::string_view{c, s}};
}

inline shared_model::interface::types::SignedHexStringView operator""_hex_sign(
    const char *c, size_t s) {
