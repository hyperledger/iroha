  ...
  void prepareTestData() {
    ...
    auto genesis_tx =
        shared_model::proto::TransactionBuilder()
            ...
            .addPeer("0.0.0.0:10001", node0_signer_->publicKey())
            ...
            .createAccount(kAdminName, kDomain, admin_signer_->publicKey())
            .createAccount(kUser, kDomain, user_signer_->publicKey())
