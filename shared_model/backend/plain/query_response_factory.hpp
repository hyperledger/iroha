...
#ifndef IROHA_PLAIN_QUERY_RESPONSE_FACTORY_HPP
#define IROHA_PLAIN_QUERY_RESPONSE_FACTORY_HPP
...
namespace shared_model {
  namespace plain {
    ...
    class QueryResponseFactory : public interface::QueryResponseFactory {
     public:
...
#endif  // IROHA_PLAIN_QUERY_RESPONSE_FACTORY_HPP
